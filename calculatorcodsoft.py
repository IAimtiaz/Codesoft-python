...
if __name__ == "__main__":
  ...
  plus = Button(gui, text=' + ', fg='white', bg='sky blue',
        command=lambda: press("+"), height=2, width=8)
  plus.grid(row=2, column=3)

  minus = Button(gui, text=' - ', fg='white', bg='sky blue',
        command=lambda: press("-"), height=2, width=8)
  minus.grid(row=3, column=3)

  multiply = Button(gui, text=' * ', fg='white', bg='sky blue',
          command=lambda: press("*"), height=2, width=8)
  multiply.grid(row=4, column=3)

  divide = Button(gui, text=' / ', fg='white', bg='sky blue',
        command=lambda: press("/"), height=2, width=8)
